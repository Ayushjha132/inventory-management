...
export default function Expenses() {
    ...
    const classNames = {
        ...
        selectInput: "mt-1 block w-full pl-3 pr-10 py-2 text-base border border-gray-300 focus:ring-indigo-500 focus:border-indigo-500 smLtext-sm rounded-md"
    }
        ...
        <div>
            ...
            <div className="mb-5">
                ...
                <p className="text-sm text-gray-500">
                    A visual repersentation of expenses over time.
                </p>
            </div>
